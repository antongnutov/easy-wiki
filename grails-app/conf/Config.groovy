...
log4j = {
	appenders {
		console name:'stdout', layout:pattern(conversionPattern: '%d{ISO8601} %-5p [%c{3}] - %m%n')
...
grails.plugins.springsecurity.authority.className = 'wiki.security.Role'
...
grails.plugins.springsecurity.interceptUrlMap = [
    ...
    'wikiPage/**':   ['ROLE_WIKI_ADMIN', 'IS_AUTHENTICATED_FULLY'],
    ...
    '/*':            ['ROLE_WIKI', 'ROLE_WIKI_ADMIN', 'IS_AUTHENTICATED_REMEMBERED'],
 ]
