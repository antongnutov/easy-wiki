...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${resource(dir:'css',file:'wikisearch.css')}" />
  ...
  <body onload="focusQueryInput();">
    <div id="pageBody" class="body">
        ...
        <div class="menuButtons">
          <span class="menuButton"><a class="wiki" href="${createLink(controller: 'wiki', action: 'wiki', params: [id: 'Home'])}">Wiki Home</a></span>
          ...
          <sec:ifAllGranted roles="ROLE_WIKI_ADMIN">
            ...
            <span class="menuButton"><a class="pageAdd" href="${createLink(controller: 'wikiPage', action: 'create')}">New Page</a></span>
          </sec:ifAllGranted>
        </div>
